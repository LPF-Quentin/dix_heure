 ...
 * Date :      Fri, 20 Aug 2010 20:42:43 GMT
 * Compile :   Fri, 20 Aug 2010 22:06:19 GMT
 * Boucles :   
 */ 
//
...
') :
		'') .
(($t1 = '<'.'?php header("' . (	'Content-Type: text/javascript; charset=' .
...
$.fn.barre_previsualisation = function(settings) {
	options = {
		previewParserPath:"' .
interdire_scripts(url_absolue(generer_url_public('porte_plume_preview'))) .
'",
		textEditer:"' .
